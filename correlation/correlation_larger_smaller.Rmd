...
cat(sprintf("In following plots, we can see relationship between variables '%s' a '%s' separately for groups %s and %s. Decide, which correlation is larger.", df_currvars$name[1], df_currvars$name[2], df_assignmnent$group1, df_assignmnent$group2))
```
