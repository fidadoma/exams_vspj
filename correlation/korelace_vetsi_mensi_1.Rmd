...
plot_titles <- c("Smutní lidé","Veselí lidé")
...
V následujících grafech vidíme vztahy mezi proměnnými `r  df_currvars$name[1]` a `r df_currvars$name[2]` zvlášť pro smutné a spokojené lidí. Rozhodněte, zda je větší korelace pro podskupinu smutných nebo veselých lidí.
