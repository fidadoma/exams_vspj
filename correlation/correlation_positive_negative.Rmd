...
cat(sprintf("In following plots, we can see relationship between variables '%s' a '%s' separately for groups %s a %s. Decide, whether each correlation is positive or negative.", df_currvars$name[1], df_currvars$name[2], df_assignmnent$group1, df_assignmnent$group2))
```
