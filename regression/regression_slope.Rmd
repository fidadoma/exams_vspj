...
Lineární závislost popisujeme rovnicí ve tvaru $y = b_1x+b_0$. Spočítejte regresní koeficient $b_1$ přímky předpovídající proměnnou '`r df_currvars$name[2]`' v závislosti na proměnné '`r df_currvars$name[1]`'. Data vypadají následovně:
