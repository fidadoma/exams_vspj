...
Spočítejte koeficient determinace ($R^2$) předpovídající proměnnou '`r df_currvars$name[2]`' v závislosti na proměnné '`r df_currvars$name[1]`'. Data vypadají následovně:
