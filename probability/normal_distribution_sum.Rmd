...
df_assignmnent <- get_prob_var(distr_type = "normal", curr_theme = curr_theme,norm_type = "sum", language = lang)
...
l <- probability_normal_setting_sum(k, n, mu_param, sigma_param, quantifier, language = lang)
solution <- l$solution
