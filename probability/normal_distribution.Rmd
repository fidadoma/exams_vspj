...
df_assignmnent <- get_prob_var(distr_type = "normal", curr_theme = curr_theme, language = lang)
...
l <- probability_normal_setting(k, mu_param, sigma_param, quantifier,language = lang)
solution <- l$solution
