...
df_assignmnent <- get_prob_var(distr_type = "normal", curr_theme = curr_theme, norm_type = "perc")
...
l <- probability_normal_setting_perc(perc/100, mu_param, sigma_param,direction = direction)
solution <- l$solution
