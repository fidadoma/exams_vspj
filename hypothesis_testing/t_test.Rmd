...
V daném případě jsou parametry n=`r n`, $\bar{x}$=`r exams::fmt(x_bar, zeros = F)`, $s_x$ = `r sx` a $\mu_0$ = `r exams::fmt(popul_mean, zeros = F)`. Dostaneme tedy hodnotu `r t %>% round(2)`. 
