...
explanation_text_tmp2 <- if_else(is_signif  == 1, "Jelikož je p-hodnota menší než hladina významnosti, můžeme zamítnou nulovou hypotézu ve prospěch alternativní.", "Jelikož je p-hodnota větší než hladina významnosti, nemůžeme zamítnou nulovou hypotézu ve prospěch alternativní. Pozor, neznamená to, že platí nulová hypotéza, pouze ji nemůžeme vyvrátit."
)
...
Byli jsme požádáni o zpracování analýzy, zda se hodnoty proměnné '`r df_currvars$name[1]`' na nasbíraném vzorku liší `r test_type_text`. Pracujeme s hladinou významnosti `r alpha_param`%. Získali jsme p-hodnotu rovnou `r p_val %>% round(3)`. Které z následujících tvrzení platí?
