...
Byli jsme požádáni o zpracování analýzy, zda se hodnoty proměnné '`r df_currvars$name[1]`' na nasbíraném vzorku liší `r test_type_text`. Pracujeme s hladinou významnosti `r alpha_param`%. Získali jsme p-hodnotu rovnou `r p_val`. Pokud by ve skutečnosti `r population_true_text` a my správně interpretovali výsledky testy, které z následujících tvrzení platí?
