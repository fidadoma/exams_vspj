...
if (runif(1) < 0.5) {
  ...
  if(lang == "CZ") {
    ...
    solution_text <- "stačí spočítat směrodatnou odchylku výběru. Můžeme to udělat v Jamovi"
  } else {
    estim_type <- "standard deviance"
  solution_text <- "we just compute sample standard deviation. We can do that using Jamovi"
  }
